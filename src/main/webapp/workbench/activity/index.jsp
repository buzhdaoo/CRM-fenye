...
<script type="text/javascript">
	...
	/*
		...
		pageList方法：就是发出发出ajax请求，从后台取得最新的市场活动信息列表数据
					  通过响应回来的数据，局部刷新新市场活动列表
		我们都在那种情况下，需要调用pageList方法（声明情况下需要刷新一下市场活动列表）
		（1）点击左侧菜单中的市场活动超链接
		（2）添加，修改，删除后需要刷新市场活动列表
		（3）点击查询的时候，需要刷新市场活动列表
		（4）点击分页组件的时候

	*/
	function pageList(pageNo,pageSize) {
		$.ajax({
			url:"workbench/activity/pageList.do",//前面不加/
			data:{
				"pageNo":pageNo,
				"pageSize":pageSize,
